  ...
  if (!data || !data.lesson) {
    return (
      <div className="flex-1 flex justify-center items-center">
        <p className="text-sm text-gray-50 md:text-3xl">Carregando...</p>
      </div>
    );
  }
    ...
    <div className="flex-1 z-0">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className=" gap-16   md:flex md:items-start ">
          ...
          <div className="flex mt-6 flex-col gap-4 md:mt-0">
            <a
              href=""
        ...
        <div className="gap-8 mt-20 grid auto-rows-[9.438rem] md:grid-cols-2">
          <a
            href=""
            className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-2 md:gap-6 hover:bg-gray-600 transition-colors"
          >
            <div className="bg-green-700 h-full p-4 flex items-center md:p-6">
              <FileArrowDown size={40} />
            </div>
            <div className="py-3 leading-relaxed md:py-6">
              <strong className="text-lg md:text-2xl">Material complementar</strong>
              <p className="text-xs   text-gray-200 mt-1 md:mt-2 md:text-sm">
                Acesse o material complementar para acelerar o seu
                desenvolvimento
              </p>
            </div>
            <div className="h-full p-4 flex items-center md:p-6">
              <CaretRight size={24} />
            </div>
          </a>
